...
<div>
  ...
  <div class="chat-container" :class="(isOpen ? 'show' : 'hide')">
    <div class="chat-window">
      ...
      <div id = "ChatArea" ref="chatArea" class="chat-area" :style="{background: messageBackgroundColorProp}">
      ...
      <div class="chat-input">
        <form @submit.prevent="handleOutboundMessage()" class="chat-form">
          ...
          <!-- <v-icon name="send" base-class="icon-send-message" :style="{color: iconColorProp, width: '30px'}"></v-icon> -->
          <svg data-v-6d002ea3="" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon-send-message icon-send" style="color: rgb(230, 230, 230); width: 30px;"><line x1="22" x2="11" y1="2" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>
          </button>
        </form>
      </div>
    </div>
